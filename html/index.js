...
(function dartProgram() {
  ...
  E = {
    main: function() {
      var t1 = document,
        botao = t1.createElement("button");
      botao.id = "confirmar";
      botao.textContent = "Clique para confirmar";
      botao.classList.add("importante");
      C.ButtonElement_methods._addEventListener$3(botao, "click", H.functionTypeCheck(new E.main_closure(), {func: 1, args: [W.Event]}), null);
      t1.querySelector("#registration").appendChild(botao);
    },
  ...
  E.main_closure.prototype = {
    call$1: function(e) {
      ...
      return window.alert("confirmado!");
    },
    $signature: 1
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, H.Closure, P.Error, P.bool, P.num, P._Exception, P.List, P.Null, P.String, P.StringBuffer]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString, W.EventTarget, W.DomException, W.DomTokenList, W.Event]);
    _inheritMany(J.JavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction]);
    _inherit(J.JSUnmodifiableArray, J.JSArray);
    _inheritMany(J.JSNumber, [J.JSInt, J.JSDouble]);
    _inheritMany(H.Closure, [H.TearOffClosure, H.initHooks_closure, H.initHooks_closure0, H.initHooks_closure1, E.main_closure]);
    ...
    _inheritMany(W.HtmlElement, [W.AnchorElement, W.AreaElement, W.ButtonElement, W.FormElement, W.SelectElement]);
  })();
  (function constants() {
...
;
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, args: [,]}, {func: 1, ret: -1, args: [W.Event]}], interceptorsByTag: null, leafTags: null};
